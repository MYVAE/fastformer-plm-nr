...
class DataLoaderTest(DataLoaderTrain):
    ...
    def _process(self, batch):
        ...
        user_feature_batch, log_mask_batch, news_feature_batch, news_bias_batch, label_batch,  impression_id_batch = [], [], [], [], [], []
        ...
        return user_feature_batch, log_mask_batch, news_feature_batch, news_bias_batch, label_batch, impression_id_batch
